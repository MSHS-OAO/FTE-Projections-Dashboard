      ...
      tabItem(tabName = "home",
              ...
              column(12,
                     tags$div(id = "data description", style = "color: #221f72; font-size:14px; margin-left: 20px",
                              ...
                              h5("* Worked hours does not include provider and agency labor."),
              ...
              fluidRow(
                ...
                column(11,
                       box(
                         ...
                         fluidRow(
                           box(width = 4, height = "100px", title = "Select Operational Category:", solidHeader = FALSE,
                               pickerInput("mshs_selected_group", label = NULL, multiple = TRUE,
                                           options = pickerOptions(actionsBox = TRUE), choices = group_choices,
                                           selected = group_choices)),
                           box(width = 4, height = "100px", title = "Select Operational Subcategory:", solidHeader = FALSE,
                               pickerInput("mshs_selected_service", label = NULL, multiple = TRUE,
                                           options = pickerOptions(
                                             liveSearch = TRUE,
                                             actionsBox = TRUE,
                                             dropupAuto = FALSE),
                                           choices = service_choices, selected = service_choices)),
              ...
              fluidRow(
                column(11,
                       box(
                         ...
                         solidHeader = TRUE, collapsible = TRUE, closable = TRUE, br(),
                         fluidRow(
                           box(width = 2, height = "100px", title = "Select Hospital:", solidHeader = FALSE,
                               pickerInput("selected_payroll", label = NULL, multiple = TRUE,
                                           options = pickerOptions(actionsBox = TRUE), choices = payroll_choices,
                                           selected = payroll_choices)),
                           box(width = 3, height = "100px", title = "Select Operational Category:", solidHeader = FALSE,
                               pickerInput("selected_group", label = NULL, multiple = TRUE,
                                           options = pickerOptions(actionsBox = TRUE), choices = group_choices,
                                           selected = group_choices)),
                           box(width = 4, height = "100px",
                               title = "Select Operational Subcategory:",
                               solidHeader = FALSE,
